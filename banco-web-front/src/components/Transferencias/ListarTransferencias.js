...
class ListarTransferencias extends Component{
    ...
    componentDidMount(){
        ...
        return fetch(`http://localhost:3001/api/transferencias/getall/${id}`)
                                        ...
                                        <table className="table">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Cliente</th>
                                                    <th>Beneficiário</th>
                                                    <th>Uso de Cartão de Crédito</th> 
                                                    <th>Valor do Débido no cartão</th>
                                                    <th>Criação</th>                            
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    this.state.dados.map((item,indice) => {
                                                        ...
                                                        return (
                                                            ...
                                                            <tr key={indice}>
                                                                ...
                                                                {item.carto?item.carto.bandeira:null}{item.carto?" / ":""}{item.carto?item.carto.numero:""}
                                                                
                                                                </td>
                                                                <td>R$ {item.valor_devido}</td>
...
export default withAuth(ListarTransferencias);